...
set_property PACKAGE_PIN M24 [get_ports clk_LED]
set_property IOSTANDARD LVCMOS33 [get_ports clk_LED]

set_property PACKAGE_PIN M20 [get_ports clr_LED]
set_property IOSTANDARD LVCMOS33 [get_ports clr_LED]

set_property PACKAGE_PIN L24 [get_ports o_LED]
set_property IOSTANDARD LVCMOS33 [get_ports o_LED]

set_property PACKAGE_PIN R18 [get_ports EN_LED]
